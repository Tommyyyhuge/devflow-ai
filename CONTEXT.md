...
| **预算上限** | 用户可配置的美元费用上限。默认：周上限 $20，5小时上限 $3.5。超出后 Agent 拒绝新任务 |
| **TokenBudget** | 执行级 Token 数量上限（默认 140K）。防止单次任务爆上下文窗口，与成本无关 |
| **CostBudget** | 账户级美元成本上限。CostTracker 累计会话花费，达到 $20/周或 $3.5/5h 后拒绝新任务 |
